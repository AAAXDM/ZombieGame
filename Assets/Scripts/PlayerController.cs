...
using ZombieFight.ScreenBounds;
...
namespace ZombieFight
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private void CheckPlayerPosition()
        {
            ...
            if (playerPos.z > ScreenBounds.ZRange.Item2)
            {
                playerPos.z = ScreenBounds.ZRange.Item2;
            ...
            else if (playerPos.z < ScreenBounds.ZRange.Item1)
            {
                playerPos.z = ScreenBounds.ZRange.Item1;
                if (movementDirection.z < 0)
                {
                    movementDirection.z = 0;
                    movementDirection.x = 0;
            ...
            if (playerPos.x > ScreenBounds.XRange.Item2)
            {
                playerPos.x = ScreenBounds.XRange.Item2;
                if (movementDirection.x > 0)
                {
                    movementDirection.x = 0;
                }
            }
            else if (playerPos.x < ScreenBounds.XRange.Item1)
            {
                playerPos.x = ScreenBounds.XRange.Item1;
                if (movementDirection.x < 0)
                {
                    movementDirection.x = 0;
                }
